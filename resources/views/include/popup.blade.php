    ...
    <div class="modal-dialog modal-dialog-centered web_header_modal_zoom addToCartPopup_container" role="document">
      <div class="modal-content addToCartPopup_content">
        <div class="addToCartPopup_header">
          <a type="button" class="addToCartPopup_header_btn" data-dismiss="modal" aria-label="Close">
